  ...
  const handleDelete = async (blog) => {
    if (window.confirm(`Remove blog ${blog.title} by ${blog.author}?`)) {
      try {
        ...
        setSuccessMessage(`Successfully removed blog ${blog.title}.`)
        setTimeout(() => setSuccessMessage(null), 5000)
      } catch {
        setErrorMessage('Failed to delete blog. You may not have permission.')
    ...
    <div>
      ...
      {user &&
        <div>
          ...
          <BlogList blogs={sortedBlogs} user={user} handleLikes={handleLikes} handleDelete={handleDelete} />
